#define NGX_CONFIGURE " --prefix=/home/minglin/workspace/nginx-1.4.1/dist --conf-path=conf/spdy.conf --with-http_ssl_module --with-http_spdy_module --with-pcre=./libs/pcre-8.32 --with-zlib=./libs/zlib-1.2.8 --with-debug --with-openssl=./libs/openssl-1.0.1e"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.6.2 20111027 (Red Hat 4.6.2-1) (GCC) "
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/minglin/workspace/nginx-1.4.1/dist/"
#endif
...
#define NGX_CONF_PATH  "conf/spdy.conf"
#endif
